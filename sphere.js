window.addEventListener('DOMContentLoaded', function() {
  ...
  var createScene = function() {
    ...
    borderRight.physicsImpostor = new BABYLON.PhysicsImpostor(borderRight, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, restitution: 0.9 }, scene);
    ...
    borderLeft.physicsImpostor = new BABYLON.PhysicsImpostor(borderLeft, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, restitution: 0.9 }, scene);
    ...
    borderTop.physicsImpostor = new BABYLON.PhysicsImpostor(borderTop, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, restitution: 0.9 }, scene);
    ...
    borderBottom.physicsImpostor = new BABYLON.PhysicsImpostor(borderBottom, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, restitution: 0.9 }, scene);




    var boxLeft = BABYLON.MeshBuilder.CreateBox("box", {height: 0.1, width: 0.1, depth: 1, faceColors: [0,0,0,0]}, scene);
    boxLeft.position.y = 0.1
    boxLeft.position.x = 3
    boxLeft.position.z = 1
    boxLeft.physicsImpostor = new BABYLON.PhysicsImpostor(boxLeft, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 100, restitution: 0.9 }, scene);
      //boxLeft.physicsImpostor.setLinearVelocity(new BABYLON.Vector3(3, 0, 1));
    boxLeft.physicsImpostor.applyImpulse(new BABYLON.Vector3(100, 0, 100), boxLeft.getAbsolutePosition());

    var boxRight = BABYLON.MeshBuilder.CreateBox("box", {height: 0.1, width: 0.1, depth: 1, faceColors: [0,0,0,0]}, scene);
    boxRight.position.y = 0.1
    boxRight.position.x = -3
    boxRight.position.z = 1
    boxRight.physicsImpostor = new BABYLON.PhysicsImpostor(boxRight, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 100, restitution: 0.9 }, scene)
      //boxRight.physicsImpostor.setLinearVelocity(new BABYLON.Vector3(3, 0, 1))
    boxRight.physicsImpostor.applyImpulse(new BABYLON.Vector3(100, 0, 100), boxRight.getAbsolutePosition());
    ...
    sphere.physicsImpostor.setLinearVelocity(new BABYLON.Vector3(3, 0, 1));
